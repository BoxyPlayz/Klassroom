...
export default function Account() {
	...
	return (
		<>
			...
			{session?.user.image ?
				<img
					src={!hasError ? session?.user.image : "https://www.shutterstock.com/image-vector/blank-avatar-photo-place-holder-600nw-1095249842.jpg"}
					height={40}
					width={40}
			...
			<form
				onSubmit={async (e) => {
					...
					const { data, error } = await authClient.passkey.addPasskey({
						name: (
							passkeyRef.current || { value: 'getttttdduuunnkkkeedddooonn' }
						).value,
